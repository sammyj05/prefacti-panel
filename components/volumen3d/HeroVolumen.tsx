 ...
 * Intro.
 *
 * Es el mismo hero que el de la portada de píxeles, y a propósito: las dos
 * páginas tienen que leerse como la misma casa. La primera pantalla se deja
 * entera para lo que hay detrás —allí la trama, aquí la manzana en obra— y lo
 * único que vive aquí son los dos rótulos del canto y la señal de bajar.
 */
export function HeroVolumen() {
  ...
  return (
    <>
      ...
      <section ref={tramo} className="relative h-screen">
        ...
        >
          6 promociones en obra · 1.997 unidades
        </motion.span>
        ...
        >
          ...
          >
            <span>Desplaza y míralo levantarse</span>
            <motion.span
              animate={{ y: [0, 6, 0] }}
